...
Emitter::Emitter(size_t _numParticles, const ngl::Vec3 &_emitDir)
{
    ...
    //generate vertex array obejct buffer
...
{
    //CAMERA CHANGE NEAR AND FAR CLIPPING PLANE AS WELL if changing
    auto view = ngl::lookAt({1,5,5},{0,0,0},{0,1,0});
    auto project = ngl::perspective(45.0f,1.0f,0.1f,10.0f);
    ...
    for (auto p : m_particles)
    {
        ...
        //sets the translate elements of the transform matrix
